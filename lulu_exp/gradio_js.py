...
# from zhipu_question2response import question2response
...
def callback_post_extract(response):
    ...
    with open(save_file, "a", encoding="utf-8") as f:
        f.write(json.dumps({"query": current_query, "response": response, "js_code": python_code}, ensure_ascii=False) + "\n")
...
with gr.Blocks() as demo:
    ...
    submit_button.click(
        ...
        prompt2response,
        inputs=[prompt_output, model_selector],
